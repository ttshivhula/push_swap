...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/06/17 14:04:32 by ttshivhu          #+#    #+#             */
/*   Updated: 2017/07/21 14:13:25 by ttshivhu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static char		*prepline(t_fd_pack *pack, void *newline)
{
	int					offset;
	char				*out;
